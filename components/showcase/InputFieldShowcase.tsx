...
const MODES: InputFieldMode[] = ["White", "Black"];

export function InputFieldShowcase() {
  const [activeState, setActiveState] = useState<
    InputFieldState | "Interactive"
  >("Interactive");
  const [activeMode, setActiveMode] = useState<InputFieldMode>("White");
  ...
  const controlBorder =
    activeMode === "White" ? "rgba(255,255,255,0.2)" : "rgba(0,0,0,0.15)";
